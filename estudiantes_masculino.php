...
<article class="panel is-link">
  <p class="panel-heading has-text-centered has-text-weight-normal is-size-7">LISTADO GENERAL ESTUDIANTES MASCULINO</p>
...
WHERE sexo.id_sexo='1' ORDER BY id_estudiantes;");
