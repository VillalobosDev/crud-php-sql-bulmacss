...
<div id="modal-js-example" class="modal">
  ...
  <div class="modal-card">
    <header class="modal-card-head">
      <p class="modal-card-title">Agregar Nivel</p>
      <button class="delete" aria-label="close"></button>
    </header>
    <section class="modal-card-body">
      

    <form class="" action="config_agregar_nivel.php" name="frmContacto" method="POST">

    <div class="field">
    <label class="label">Nivel</label>
    <div class="control">
      <input class="input is-small" type="text" id="nivel" name="nivel" placeholder="Nivel" 
