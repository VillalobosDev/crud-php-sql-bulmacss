...
<article class="panel is-link">
  <p class="panel-heading has-text-centered has-text-weight-normal is-size-7">AGREGAR DOCENTE</p>





  <form class="box" action="config_agregar_docentes.php" name="frmContacto" method="POST">
...
<div class="columns is-mobile is-centered">
           <div class="buttons">
<button class="button is-primary is-small" type="submit" name="agregar">Agregar Docente</button>
