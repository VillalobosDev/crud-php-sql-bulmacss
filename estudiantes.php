...
<article class="panel is-link">
  <p class="panel-heading has-text-centered has-text-weight-normal is-size-7">LISTADO GENERAL ESTUDIANTES REGISTRADOS</p>
...
sexo.sexo
FROM estudiantes 
INNER JOIN sexo ON estudiantes.id_sexo = sexo.id_sexo ORDER BY id_estudiantes;");
...
<a href="ficha_estudiante.php?id_estudiantes=<?php print($linea['id_estudiantes']); ?>">
<button class='button is-small is-responsive is-info'>Ficha</button></a>


<a href="modificar_estudiantes.php?id_estudiantes=<?php print($linea['id_estudiantes']); ?>">
<button class='button is-small is-responsive is-link'>Modificar</button></a>



<button data-target="#eliminar_<?php echo $linea['id_estudiantes']; ?>" 
...
<?php
include "ventana_modal_eliminar_estudiantes.php";
?>
...
INNER JOIN sexo ON estudiantes.id_sexo = sexo.id_sexo ORDER BY id_estudiantes;");
$consulta->execute();
$estudiantes = $consulta->rowCount();
?>
      <span class="tag is-dark">Total registros:</span>
      <span class="tag is-success"><?php print("$estudiantes\n"); ?></span>
</div>
</div>
