...
<article class="panel is-link">
  <p class="panel-heading has-text-centered has-text-weight-normal is-size-7">MODIFICAR DOCENTE</p>

<?php
$id_docentes= $_GET['id_docentes'];
$consulta = $DB_con->prepare("SELECT * FROM docentes WHERE id_docentes=:id_docentes");
...
<form class="box" action="config_modificar_docentes.php" name="frmContacto" method="GET">
...
<div class="columns is-mobile is-centered">
           <div class="buttons">
<button class="button is-link is-small" type="submit" name="modificar">Modificar Docente</button>
