...
$sql = $DB_con->prepare("UPDATE estudiantes SET cedula=:cedula, nombres=:nombres, apellidos=:apellidos, fecha_nacimiento=:fecha_nacimiento, edad=:edad, id_sexo=:id_sexo, correo=:correo, telefono=:telefono WHERE id_estudiantes=:id_estudiantes");
...
$sql->bindParam(':id_estudiantes', $_GET['id_estudiantes']);
$sql->execute();
if($sql)
  {
