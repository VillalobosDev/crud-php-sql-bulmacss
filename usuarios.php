...
<article class="panel is-link">
  <p class="panel-heading has-text-centered has-text-weight-normal is-size-7">LISTADO GENERAL nivel</p>

<?php
$consulta = $DB_con->prepare("SELECT * FROM nivel ORDER BY id_nivel;");
 ...
 <table id="myTable" class="table is-hoverable table is-mobile is-fullwidth has-text-centered">
        <thead>
          <tr>
              ...
              <th class="has-text-centered has-text-weight-normal">nivel</th>
...
echo "
        <tbody>
          <tr>
            ...
            <td><?php echo $linea['id_nivel']; ?></td>
            <td><?php echo $linea['nivel']; ?></td>           
<td>

<button data-target="#modificar_<?php echo $linea['id_nivel']; ?>" 
class='button is-small is-responsive is-link js-modal-trigger'>Modificar</button>

<button data-target="#eliminar_<?php echo $linea['id_nivel']; ?>" 
...
<?php
include "ventana_modal_modificar_nivel.php";
include "ventana_modal_eliminar_nivel.php";
?>
...
<?php
$consulta = $DB_con->query("SELECT * FROM nivel");
$consulta->execute();
$nivel = $consulta->rowCount();
?>
      <span class="tag is-dark">Total registros:</span>
      <span class="tag is-success"><?php print("$nivel\n"); ?></span>
</div>
</div>
...
<!-- ventana modal-->
<?php
include "ventana_modal_agregar_nivel.php";
?>
<!-- fin ventana modal-->
  </body>
</html>