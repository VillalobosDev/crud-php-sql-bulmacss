...
if(isset($_POST['agregar'])){
  $sql = "SELECT cedula FROM docentes WHERE cedula = :cedula LIMIT 1"; //Creamos la select
...
$sql=$DB_con->prepare("INSERT INTO docentes (cedula, nombres, apellidos, fecha_nacimiento, edad, id_sexo, correo, telefono) 
