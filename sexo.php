...
echo "
        <tbody>
          <tr>
            ...
            <td><?php echo $linea['id_sexo']; ?></td>
            <td><?php echo $linea['sexo']; ?></td>           
<td>

<button data-target="#modificar_<?php echo $linea['id_sexo']; ?>" 
class='button is-small is-responsive is-link js-modal-trigger'>Modificar</button>

<button data-target="#eliminar_<?php echo $linea['id_sexo']; ?>" 
...
<?php
$consulta = $DB_con->query("SELECT * FROM sexo");
$consulta->execute();
...
<!-- ventana modal-->
<?php
include "ventana_modal_agregar_sexo.php";
?>
<!-- fin ventana modal-->
  </body>
</html>